  ...
  return (
    <div className="twocol">
      <div>
        ...
        <h1 className="page-title">A studio rooted in Juba, thinking continent-wide</h1>
        <p className="page-subtitle">
          Savvy Gorilla Technologies was born from a simple observation: African
          teams and creatives are doing serious work, but often without tools
          and narratives that match the weight of what they carry.
        </p>
        ...
        <section className="section">
          ...
          <ul className="list">
            ...
            <li>
              We care about design that feels modern without forgetting where it
              is coming from.
            </li>
            <li>
        ...
        <section className="section">
          ...
          <ul className="list">
            ...
            <li>
              <strong>Care for people.</strong> Behind every dashboard, report,
              or podcast episode are human beings trying to do their best inside
              imperfect systems.
            </li>
            <li>
              <strong>Documenting the journey.</strong> We are intentional about
              archiving processes so that others can learn, adapt, and build on
              what exists.
            </li>
          </ul>
        </section>
        ...
        <section className="section">
          <div className="section-header">
            ...
            <p className="section-text">
              ...
              designer or developer. You are bringing in a thinking partner who
              cares about the long-term life of your idea.
            </p>
          </div>
          <ul className="list">
      ...
      <aside className="twocol-aside">
        ...
        <p>
          <strong>Creative &amp; Communications lead.</strong> Humanitarian and
          development communication, gender and protection work, and a strong
          eye for how stories land with communities and donors.
        </p>
        <p>
