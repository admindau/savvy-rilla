export default function HomePage() {
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.15),transparent_38%)]" />
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-6 text-center">
        <div className="mx-auto mb-8 w-fit rounded-full border border-white/18 bg-black/55 px-6 py-2 text-xs uppercase tracking-[0.42em] text-white/65 shadow-[0_0_36px_rgba(255,255,255,0.1)] backdrop-blur-xl">
          Savvy Rilla Technologies
        </div>

        <h1 className="text-6xl font-black leading-[0.88] tracking-[-0.065em] sm:text-8xl lg:text-[10rem]">
        ...
        <div className="relative mx-auto mt-8 h-px w-[34rem] max-w-full bg-gradient-to-r from-transparent via-white/55 to-transparent">
