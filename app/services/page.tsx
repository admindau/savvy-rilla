  ...
  return (
    <div className="twocol">
      <div>
        ...
        <section className="section">
          <div className="section-header">
            ...
            <p className="section-text">
              For teams and founders who want working tools — not endless slide
              decks. We help you design, prototype, and ship.
            </p>
          </div>
          <ul className="list">
            <li>
              <strong>Web apps &amp; dashboards.</strong> Modern, responsive
              interfaces for finance tracking, internal reporting, and workflow
              tools.
            </li>
            <li>
            ...
            <li>
              <strong>Domain &amp; hosting guidance.</strong> Practical support
              on where to host, how to structure domains, and how to keep things
              simple and maintainable.
            </li>
            <li>
              <strong>Technical advisory.</strong> Friendly support when you
              need a second brain on IT decisions, especially in resource-tight
              environments.
            </li>
          </ul>
        </section>
        ...
        <section className="section">
          <div className="section-header">
            <h2 className="section-title">Media, podcasts &amp; storytelling</h2>
            <p className="section-text">
          ...
          <ul className="list">
            ...
            <li>
              <strong>Docu-series concepting.</strong> High-level story design,
              structure for episodes, and visual direction in collaboration with
              production partners.
            </li>
            <li>
        ...
        <section className="section">
          ...
          <ul className="list">
            ...
            <li>
              ...
              Scorecard–style mapping and facilitation to connect activities to
              results.
            </li>
          </ul>
        </section>
